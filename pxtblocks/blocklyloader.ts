...
namespace pxt.blocks {
    ...
    function initMath() {
        ...
        Blockly.Blocks[mathOp2Id] = {
            init: function () {
                ...
                setHelpResources(this,
                    ...
                    mathOp2Def.url,
                    String(blockColors[mathOp2Def.category])
                );
            }
        };
        ...
        installHelpResources(
            ...
            String(blockColors[mathArithmeticDef.category])
        );
    ...
    function initFunctions() {
        ...
        Blockly.Blocks['procedures_callnoreturn'] = {
            ...
            customContextMenu: function (options: any) {
                let option: any = { enabled: true };
                option.text = Util.rlf((Blockly as any).Msg.PROCEDURES_HIGHLIGHT_DEF);
                let name = this.getProcedureCall();
        ...
        Blockly.Procedures.flyoutCategory = function (workspace: Blockly.Workspace) {
            ...
            function populateProcedures(procedureList: any, templateName: any) {
                for (let i = 0; i < procedureList.length; i++) {
                    ...
                    block.setAttribute('colour', String(blockColors['functions']));
